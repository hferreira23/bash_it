...
BATTERY_CHAR_AC=${BATTERY_CHAR_AC:=""}
BATTERY_CHAR_GOOD=${BATTERY_AC_CHAR_GOOD:=""}
BATTERY_CHAR_MEDIUM=${BATTERY_AC_CHAR_MEDIUM:=""}
BATTERY_CHAR_LOW=${BATTERY_AC_CHAR_LOW:=""}
BATTERY_CHAR_CRITICAL=${BATTERY_AC_CHAR_CRITICAL:=""}

BATTERY_STATUS_THEME_PROMPT_GOOD_COLOR=${POWERLINE_BATTERY_GOOD_COLOR:=28}
BATTERY_STATUS_THEME_PROMPT_MEDIUM_COLOR=${POWERLINE_BATTERY_MEDIUM_COLOR:=200}
