...
. "$BASH_IT/themes/2xtreme/2xtreme.base.bash"
...
HOST_THEME_PROMPT_COLOR=${POWERLINE_HOST_COLOR:=32}
...
POWERLINE_LEFT_PROMPT=${POWERLINE_LEFT_PROMPT:="user_info hostname python_venv ruby node cwd"}
POWERLINE_RIGHT_PROMPT=${POWERLINE_RIGHT_PROMPT:="scm in_vim clock battery"}
